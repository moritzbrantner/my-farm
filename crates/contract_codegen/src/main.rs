...
use my_farm_core::{
    ...
    FarmShopSaleWindow, FarmShopState, FarmState, FarmView, FarmhouseUpgradeDef,
    FarmhouseUpgradeKind, FieldPlot, HealthResponse, HouseInterior, InventoryItemView, ItemDef,
    ItemKind, ItemStack, MachineDef, MachineJob, MachineKind, MachineState, MarketItemDef, OvenJob,
    OvenJobStatus, OvenState, PlantedCrop, RecipeDef, RecipeTarget, ReservationReasonView,
