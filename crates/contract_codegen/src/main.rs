...
use my_farm_core::{
    ...
    RecipeDef, RecipeTarget, ReservationReasonView, ReservationView, ReservedPathTileView,
    ReservedWorkTarget, ResidentCarryItemView, ResidentCarryToolView, ResidentCarryView,
    ResidentCleanupBlock, ResidentInventory, ResidentPathState, ResidentScenePoint,
    ResidentSceneView, ResidentStepView, ResidentTargetKind, ResidentTargetView, ResidentTask,
    ResidentTaskKind, ResidentTaskQueueState, ResidentTaskStep, ResidentTaskStepWork,
