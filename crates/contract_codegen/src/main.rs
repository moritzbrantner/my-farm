...
use my_farm_core::{
    AnimalReservationKey, AnimalShelterState, AnimalSlot, AnimalState, BalanceConfig,
    BlockedResidentTask, BlockedResidentTaskView, CatalogDocument, CatalogResponse, CommandRequest,
    CommandResponse, CropDef, DecorationDef, DecorationFootprint, DecorationPlacement,
    DeliveryOrder, FarmCommand, FarmEvent, FarmNotice, FarmNoticeKind, FarmResident, FarmResponse,
    FarmShopPriceView, FarmShopRejectionWindow, FarmShopSaleWindow, FarmShopState, FarmState,
    FarmView, FarmhouseUpgradeDef, FarmhouseUpgradeKind, FieldPlot, HealthResponse, HouseInterior,
    InventoryItemView, ItemDef, ItemKind, ItemStack, MachineDef, MachineJob, MachineKind,
    MachineState, MarketItemDef, OvenJob, OvenJobStatus, OvenState, PlantedCrop, RecipeDef,
    RecipeTarget, ReservationReasonView, ReservationView, ReservedPathTileView, ReservedWorkTarget,
    ResidentCarryItemView, ResidentCarryToolView, ResidentCarryView, ResidentCleanupBlock,
    ResidentInventory, ResidentPathState, ResidentScenePoint, ResidentSceneView, ResidentStepView,
    ResidentTargetKind, ResidentTargetView, ResidentTask, ResidentTaskKind,
    ResidentTaskPreviewView, ResidentTaskQueueState, ResidentTaskStep, ResidentTaskStepWork,
    ResidentTaskSummaryView, ResidentVisualActivity, ResidentVisualProp, ResidentWorkState,
    ResidentWorkView, Room, RoomTile, ShelterDef, ShelterKind, StorageKind, StorageSourceRef,
    StorageUpgradeDef, StructureKind, StructureTarget, SweepHarvestMode, Tile, ToolKind,
    ToolSourceRef, ToolStack, UnlockView, WebsocketClientMessage, WebsocketError,
    ...
    Ok(vec![
        ...
        ts_file(
            ...
            &[
                ...
                PlantedCrop::decl(),
                MachineJob::decl(),
                FarmShopRejectionWindow::decl(),
                FarmShopSaleWindow::decl(),
                FarmShopState::decl(),
                OvenJobStatus::decl(),
                OvenJob::decl(),
                OvenState::decl(),
                ...
                ResidentScenePoint::decl(),
                ResidentWorkState::decl(),
                ResidentPathState::decl(),
                ResidentVisualActivity::decl(),
                ResidentVisualProp::decl(),
                ResidentTargetKind::decl(),
                ResidentTargetView::decl(),
                ...
                ResidentCarryView::decl(),
                BlockedResidentTaskView::decl(),
                ResidentWorkView::decl(),
                ReservationReasonView::decl(),
                AnimalReservationKey::decl(),
                ReservedPathTileView::decl(),
                ReservationView::decl(),
                ResidentCleanupBlock::decl(),
                BlockedResidentTask::decl(),
                FarmState::decl(),
                FieldPlot::decl(),
                MachineState::decl(),
