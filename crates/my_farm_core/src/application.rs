...
///
/// Time-driven simulation deliberately does not pass through this CQRS boundary. The deterministic
/// core advances elapsed state directly so hot simulation work does not pay command-dispatch costs.
