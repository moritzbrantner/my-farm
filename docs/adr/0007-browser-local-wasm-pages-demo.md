...
The normal development setup remains server-authoritative with SQLite persistence. The Pages demo is deliberately narrower: it shows the early crop and bakery production loop, stores progress in the visitor's browser, and hides later systems such as animals, market trading, delivery orders, and storage upgrades.
