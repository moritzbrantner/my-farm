...
export type CatalogDocument = { balance: BalanceConfig, items: Array<ItemDef>, crops: Array<CropDef>, recipes: Array<RecipeDef>, machines: Array<MachineDef>, shelters: Array<ShelterDef>, market_items: Array<MarketItemDef>, storage_upgrades: Array<StorageUpgradeDef>, level_xp: Array<number>, };
...
export type FarmCommand = { "type": "plant_crop", plot_id: string, crop_id: string, } | { "type": "sweep_plant", crop_id: string, plot_ids: Array<string>, } | { "type": "harvest_crop", plot_id: string, } | { "type": "sweep_harvest", plot_ids: Array<string>, harvest_mode?: SweepHarvestMode, } | { "type": "buy_structure", structure_kind: StructureKind, tile: Tile, } | { "type": "upgrade_storage", storage_kind: StorageKind, } | { "type": "buy_field_plot", tile: Tile, } | { "type": "move_structure", target: StructureTarget, tile: Tile, } | { "type": "queue_recipe", machine_id: string, recipe_id: string, } | { "type": "collect_machine_job", machine_id: string, } | { "type": "feed_animal", shelter_id: string, animal_slot: string, } | { "type": "collect_animal_product", shelter_id: string, animal_slot: string, } | { "type": "fulfill_delivery_order", order_id: string, } | { "type": "discard_delivery_order", order_id: string, } | { "type": "discard_inventory", item_id: string, quantity: number, } | { "type": "buy_market_item", item_id: string, quantity: number, } | { "type": "sell_market_item", item_id: string, quantity: number, };

export type FarmEvent = { "type": "crop_planted", crop_id: string, } | { "type": "crop_harvested", crop_id: string, quantity: number, } | { "type": "field_plot_built", plot_id: string, } | { "type": "structure_built", structure_kind: StructureKind, } | { "type": "storage_upgraded", storage_kind: StorageKind, tier: number, capacity: number, } | { "type": "structure_moved", target: StructureTarget, tile: Tile, } | { "type": "recipe_queued", recipe_id: string, } | { "type": "machine_job_collected", recipe_id: string, } | { "type": "animal_fed", shelter_id: string, } | { "type": "animal_product_collected", item_id: string, } | { "type": "delivery_order_fulfilled", order_id: string, } | { "type": "delivery_order_discarded", order_id: string, } | { "type": "inventory_discarded", item_id: string, quantity: number, } | { "type": "market_item_bought", item_id: string, quantity: number, coins_spent: number, } | { "type": "market_item_sold", item_id: string, quantity: number, coins_gained: number, } | { "type": "level_changed", level: number, };
